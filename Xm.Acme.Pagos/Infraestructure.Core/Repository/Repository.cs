...
namespace Infraestructure.Core.Repository
{
    public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        ...
        public ICollection<TType> GetSelect<TType>(Expression<Func<TEntity, bool>> where, Expression<Func<TEntity, TType>> select)
        {
            return _entities.Where(where).Select(select).ToList();
        }
